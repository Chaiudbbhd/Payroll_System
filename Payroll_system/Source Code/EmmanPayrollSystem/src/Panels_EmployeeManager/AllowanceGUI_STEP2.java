 ...
 */
public final class AllowanceGUI_STEP2 extends javax.swing.JDialog {
    Connection conn;
    ResultSet rs=null;
     ...
     */
    public AllowanceGUI_STEP2() throws SQLException, IOException {
        initComponents();
    ...
    //setText the emp-id from previous step #
    public void empid_step2_Void(String empid_step2_string) {
        txt_search.setText(empid_step2_string);
    ...
    private void initComponents() {
        ...
        setName("allowance_step2"); // NOI18N
        setUndecorated(true);
        setResizable(false);
        ...
        mainpanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "MANAGE EMPLOYEE ALLOWANCE | STEP 2 of 3", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 24), new java.awt.Color(0, 102, 204))); // NOI18N
        ...
        mainpanel.add(stepexitBTN, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 0, -1, 10));
        ...
        if (txt_empid.getText().isEmpty() | txt_firstname.getText().isEmpty() | txt_surname.getText().isEmpty() | txt_dob.getText().isEmpty() | txt_salary.getText().isEmpty()  | txt_salary.getText().isEmpty()) {
            ...
            if(p==0){
                try {
                    ...
                    Logger.getLogger(AllowanceGUI_STEP2.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            try {
                new AllowanceGUI_STEP2().setVisible(true);
